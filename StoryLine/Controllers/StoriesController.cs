...
namespace StoryLine.Controllers
{
    public class StoriesController : Controller
    {
        ...
        {
            return View("Index" ,await _context.Story.Where(j => j.StoryLine.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StoryLine,title")] Story story)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StoryLine,title")] Story story)
        {
            if (id != story.Id)
            {
                return NotFound();
